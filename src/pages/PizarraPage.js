...
const styles = {
  ...
  td: { padding: '7px 10px', fontSize: 12, color: '#202124', borderBottom: '1px solid #f1f3f4', borderRight: '1px solid #f1f3f4', verticalAlign: 'middle', textAlign: 'center' },
  tdProp: { padding: '7px 10px', fontSize: 12, color: '#202124', borderBottom: '1px solid #f1f3f4', borderRight: '1px solid #f1f3f4', verticalAlign: 'middle', maxWidth: 240, textAlign: 'left' },
