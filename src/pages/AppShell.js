      ...
      <div style={{ display: 'flex', flexDirection: 'column', height: '100vh', background: '#f8f9fa', fontFamily: "'Google Sans', 'Segoe UI', sans-serif", position: 'relative' }}>
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      background: activeModule === item.id ? '#e8f0fe' : 'none',
                      border: 'none', cursor: 'pointer', textAlign: 'left',
                    }}
                  >
                    <Icon size={20} color={activeModule === item.id ? '#1a73e8' : '#5f6368'} />
                    <span style={{ fontSize: 14, fontWeight: 500, color: activeModule === item.id ? '#1a73e8' : '#3c4043' }}>
                      {item.label}
                    </span>
                  </button>
                );
        ...
        <nav style={{
          ...
          {visibleNavTop.slice(0, 4).map(item => {
            ...
            return (
              ...
              >
                ...
                <span style={{ fontSize: 10, color: active ? '#1a73e8' : '#5f6368', fontWeight: active ? 600 : 400 }}>
                  {item.label}
                </span>
              </button>
            );
          ...
          >
            ...
            <span style={{ fontSize: 10, color: moreOpen ? '#1a73e8' : '#5f6368', fontWeight: moreOpen ? 600 : 400 }}>
              Más
            </span>
          </button>
        </nav>
  ...
  return (
    ...
    >
      <span style={{ position: 'relative', display: 'inline-flex', flexShrink: 0 }}>
        <Icon
          size={20}
          style={{ color: active ? '#1a73e8' : hov ? '#3c4043' : '#5f6368', transition: 'color 0.15s' }}
        />
        {badge > 0 && (
          <span style={{
            position: 'absolute', top: -5, right: -6,
...
const styles = {
  ...
  sidebar: {
    ...
    zIndex: 100, boxShadow: '2px 0 8px rgba(0,0,0,0.08)',
  },
  sidebarHeader: {
